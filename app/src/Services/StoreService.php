...
class StoreService
{
    ...
    private $db;
    public function __construct(Contact $contact,  Phone $phone, ContactPhone $contactPhone, Lead $lead, DbConnection $db)
    {
        $this->lead = $lead;
    ...
    public function storeLead($data)
    {
        ...
        try {
            ...
            if ($data) {
                ...
                $evaluate_obj['type'] = ($data['evaluate']) ? "evaluate" : "request";
